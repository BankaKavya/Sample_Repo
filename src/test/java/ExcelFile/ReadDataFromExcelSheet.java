...

{
...

	{
		...
		String CUSTNAME = wb.getSheet("CreateCustomer").getRow(1).getCell(0).getStringCellValue();

		String CUSTDESC = wb.getSheet("CreateCustomer").getRow(1).getCell(1).getStringCellValue();
